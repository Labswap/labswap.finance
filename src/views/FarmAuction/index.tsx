...
import { Button, Heading, Text, Flex, Link } from '@labswap/uikit'
        ...
        <Flex flexDirection={['column-reverse', 'row']}>
          <Left>
            ...
            <Text bold fontSize="16px" color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid FLASK for the right to host a 7-day Farm.')}
            </Text>
            <Link external href="https://t.me/Labswapcommunity">
              <Button>
          ...
          <Right>
            <img src="/images/FLASK.svg" alt="FLASK Auction" />
          </Right>
        </Flex>
      </StyledHeader>
      <>
