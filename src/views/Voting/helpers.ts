...
import { ADMIN_ADDRESS, PANFLASK_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'cake', params: { symbol: 'FLASK', address: getCakeAddress(), decimals: 18 } }],
  }
}
